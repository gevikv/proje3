...
public class scoresAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        String mathcTime="the match time " + cursor.getString(COL_MATCHTIME);
        mHolder.date.setContentDescription(mathcTime);
       // mHolder.date.setContentDescription(cursor.getString(COL_MATCHTIME));
        ...
        mHolder.score.setContentDescription("THE SCORE IS " + score);
        ...
        if (mHolder.match_id == detail_match_id) {
            ...
            String Day = Utilies.getMatchDay(cursor.getInt(COL_MATCHDAY),
                    cursor.getInt(COL_LEAGUE));
            match_day.setContentDescription(Day);
